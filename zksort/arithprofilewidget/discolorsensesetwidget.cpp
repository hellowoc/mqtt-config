#include "discolorsensesetwidget.h"
#include "ui_discolorsensesetwidget.h"
const float senseMax = 100.0;
const float senseMin = 0.0;
DiscolorSenseSetWidget::DiscolorSenseSetWidget(QWidget *parent) :
    basewidget(parent),
    ui(new Ui::DiscolorSenseSetWidget)
{
    ui->setupUi(this);
...
DiscolorSenseSetWidget::~DiscolorSenseSetWidget()
{
    delete ui;
}

void DiscolorSenseSetWidget::showPage(bool bshow)
{
    if(bshow){
        ...
        {
            if (! m_pChuteSenseEdit[0][i]->isHidden())
            {
                struCnfp.struUnitSens[struGsh.nLayer][struGsh.nView][i][0].greyColor[struGsh.nArithIndex] = m_ChuteSensFloat[0][i] * 1023.0/100.0;
            }
            if (! m_pChuteSenseEdit[1][i]->isHidden())
            {
                struCnfp.struUnitSens[struGsh.nLayer][struGsh.nView+1][i][0].greyColor[struGsh.nArithIndex] = m_ChuteSensFloat[1][i] * 1023.0/100.0;
            }
        }
    }
}

void DiscolorSenseSetWidget::receiveMsg(int msg1, int msg2, int msg3)
{
            ...
            if(struCnfp.nMatCopySetMode == MAT_COPY_ALL_SAME || struCnfp.nMatCopySetMode == MAT_COPY_REAR_ALIKE_FRONT){//前后视相同
                if(msg2<MAX_VIEW_UNIT_USE)
                {
                    if(groupInfo.nUnitGupSplice[indexInGroup] == 2){
                        struCnfp.struUnitSens[struGsh.nLayer][struGsh.nView][unitIndex][0].greyColor[struGsh.nArithIndex]= m_ChuteSensFloat[msg2/MAX_VIEW_UNIT_USE][unitIndex]*1023.0/100.0;
                ...
                {
                    if(groupInfo.nUnitGupSplice[indexInGroup] == 2){
                        struCnfp.struUnitSens[struGsh.nLayer][struGsh.nView+1][unitIndex][0].greyColor[struGsh.nArithIndex] = m_ChuteSensFloat[msg2/MAX_VIEW_UNIT_USE][unitIndex]*1023.0/100.0;
                ...
                if(groupInfo.nUnitGupSplice[indexInGroup] == 2){
                    struCnfp.struUnitSens[struGsh.nLayer][struGsh.nView][unitIndex][0].greyColor[struGsh.nArithIndex] = m_ChuteSensFloat[struGsh.nView%2][unitIndex]*1023.0/100.0;
                }else{
                    struCnfp.struUnitSens[struGsh.nLayer][struGsh.nView][unitIndex][0].greyColor[struGsh.nArithIndex] = m_ChuteSensFloat[struGsh.nView%2][unitIndex]*1023.0/100.0;
                }
            }
...
void DiscolorSenseSetWidget::retranslateUiWidget()
{
...
void DiscolorSenseSetWidget::updateValue()//更新保留算法相关的数据
{
    ...
    ui->percentResEdit->setFloatMinMax(this, 0, 100,52,&m_percentResInt);
...
void DiscolorSenseSetWidget::updateChuteState()//更新料槽的配置精度值
{
    ...
    ui->standardlbl->setText(FloatToPercentQString((float)standardSens/1023.0*100.0));
    ...
    float stand = (float)standardSens/1023.0*100.0;
    ...
    for(int i = 0;i < tempRepeatCondition;i++){
        ...
        if(struCnfp.nMatCopySetMode == MAT_COPY_ALL_SAME || struCnfp.nMatCopySetMode == MAT_COPY_REAR_ALIKE_FRONT){//前后视相同
            ...
            if(groupInfo.nUnitGupSplice[i] == 2){
                m_ChuteSensFloat[0][unitIndex] = (float)struCnfp.struUnitSens[struGsh.nLayer][struGsh.nView][unitIndex][0].greyColor[struGsh.nArithIndex]/1023.0*100.0;
                m_ChuteSensFloat[1][unitIndex] = struCnfp.struUnitSens[struGsh.nLayer][struGsh.nView+1][unitIndex][0].greyColor[struGsh.nArithIndex]/1023.0*100.0;

            }else{
                m_ChuteSensFloat[0][unitIndex] = (float)struCnfp.struUnitSens[struGsh.nLayer][struGsh.nView][unitIndex][0].greyColor[struGsh.nArithIndex]/1023.0*100.0;
                m_ChuteSensFloat[1][unitIndex] = (float)struCnfp.struUnitSens[struGsh.nLayer][struGsh.nView+1][unitIndex][0].greyColor[struGsh.nArithIndex]/1023.0*100.0;
            }
            m_pChuteSenseEdit[0][unitIndex]->setFloatMinMax(this,senseMin-stand,senseMax-stand,unitIndex,&m_ChuteSensFloat[0][unitIndex],false);
            m_pChuteSenseEdit[1][unitIndex]->setFloatMinMax(this,senseMin-stand,senseMax-stand,unitIndex+MAX_VIEW_UNIT_USE,&m_ChuteSensFloat[1][unitIndex],false);
            ...
            if(groupInfo.nUnitGupSplice[i] == 2){
                m_ChuteSensFloat[struGsh.nView%2][unitIndex] = (float)struCnfp.struUnitSens[struGsh.nLayer][struGsh.nView][unitIndex][0].greyColor[struGsh.nArithIndex]/1023.0*100.0;
            }else{
                m_ChuteSensFloat[struGsh.nView%2][unitIndex] = (float)struCnfp.struUnitSens[struGsh.nLayer][struGsh.nView][unitIndex][0].greyColor[struGsh.nArithIndex]/1023.0*100.0;
            }
            m_pChuteSenseEdit[struGsh.nView%2][unitIndex]->setFloatMinMax(this,senseMin-stand,senseMax-stand,MAX_VIEW_UNIT_USE*(struGsh.nView%2)+unitIndex,&m_ChuteSensFloat[struGsh.nView%2][unitIndex],false);
            m_pChuteSenseEdit[struGsh.nView%2][unitIndex]->setText(FloatToPercentQString(m_ChuteSensFloat[struGsh.nView%2][unitIndex]));
        }
    }
}

void DiscolorSenseSetWidget::updateEdgeBtn()
{
...
void DiscolorSenseSetWidget::updateinfectBtn()
{
...
void DiscolorSenseSetWidget::setViewVisibleByArith()//更新保留算法控件的显示和隐藏
{
//    switch(struCnfg.struLayerInfo[struGsh.nLayer].nViewSensorType[struGsh.nView]){
//    case SENSOR_T1://可见
...
void DiscolorSenseSetWidget::updateModeBtnState()
{
...
void DiscolorSenseSetWidget::onModeChange(int mode)
{
    struCnfp.struGroupIdentify[struGsh.nLayer][struGsh.nView][struGsh.nMatGroup].struGreyColor[struGsh.nArithIndex].nMode = mode;
}

void DiscolorSenseSetWidget::updatePercentViewState()//更新比例算法相关控件的显示和隐藏
{
    //只有色差A有比例
    ui->percentCheckBox->setVisible(struGsh.nArithIndex == ARITH_DISCOLOR_A);
...
void DiscolorSenseSetWidget::updateLineDefectState()
{
    int layer = struGsh.nLayer;
    int view = struGsh.nView;
    int group = struGsh.nMatGroup;
...
void DiscolorSenseSetWidget::updateSizeState()
{
    int layer = struGsh.nLayer;
    int view = struGsh.nView;
    int group = struGsh.nMatGroup;
...
void DiscolorSenseSetWidget::on_edgeBtn_clicked(bool checked)
{
...
void DiscolorSenseSetWidget::on_infectBtn_clicked(bool checked)
{
...
void DiscolorSenseSetWidget::on_comboBox_activated(int index)
{
    if(struGsh.nArithIndex >= ARITH_DISCOLOR_A){
//        struCnfp.struGroupIdentify[struGsh.nLayer][struGsh.nView][struGsh.nMatGroup].struGreyColor[struGsh.nArithIndex].nMain = index;
        struCnfp.struGroupIdentify[struGsh.nLayer][struGsh.nView][struGsh.nMatGroup].struGreyColor[struGsh.nArithIndex].nDiffColor = index;
    }
    setAndSendParams();
}

void DiscolorSenseSetWidget::sNameChanged()
{
...
void DiscolorSenseSetWidget::on_SensUpdateCheckBox_clicked(bool checked)
{
...
void DiscolorSenseSetWidget::on_comboBox_diff_activated(int index)
{
...
//    if(index == 0){
//        struCnfp.struGroupIdentify[struGsh.nLayer][struGsh.nView][struGsh.nMatGroup].struGreyColor[struGsh.nArithIndex].struResGreyColor.nMain2 = 0;
//        struCnfp.struGroupIdentify[struGsh.nLayer][struGsh.nView][struGsh.nMatGroup].struGreyColor[struGsh.nArithIndex].struResGreyColor.nVice2 = 1;
//    }else if(index == 1){
//        struCnfp.struGroupIdentify[struGsh.nLayer][struGsh.nView][struGsh.nMatGroup].struGreyColor[struGsh.nArithIndex].struResGreyColor.nMain2 = 0;
//        struCnfp.struGroupIdentify[struGsh.nLayer][struGsh.nView][struGsh.nMatGroup].struGreyColor[struGsh.nArithIndex].struResGreyColor.nVice2 = 2;
//    }else if(index == 2){
//        struCnfp.struGroupIdentify[struGsh.nLayer][struGsh.nView][struGsh.nMatGroup].struGreyColor[struGsh.nArithIndex].struResGreyColor.nMain2 = 1;
//        struCnfp.struGroupIdentify[struGsh.nLayer][struGsh.nView][struGsh.nMatGroup].struGreyColor[struGsh.nArithIndex].struResGreyColor.nVice2 = 2;
//    }else if(index == 3){
//        struCnfp.struGroupIdentify[struGsh.nLayer][struGsh.nView][struGsh.nMatGroup].struGreyColor[struGsh.nArithIndex].struResGreyColor.nVice2 = 2;
//    }else if(index == 4 || index == 5){
//        struCnfp.struGroupIdentify[struGsh.nLayer][struGsh.nView][struGsh.nMatGroup].struGreyColor[struGsh.nArithIndex].struResGreyColor.nVice2 = 3;
//    }
    setAndSendParams();
}

void DiscolorSenseSetWidget::on_comboBox_gray_activated(int index)
{
...
void DiscolorSenseSetWidget::modeBtnClicked(bool check)//算法的选亮选暗切换
{
    if(check)
...
void DiscolorSenseSetWidget::on_percentCheckBox_clicked(bool checked)
{
    if(checked){
...
void DiscolorSenseSetWidget::on_extendBtn_clicked(bool checked)
{
    ui->groupBox_2->setVisible((struGsh.nArithIndex == ARITH_DISCOLOR_A)||(struGsh.nArithIndex == ARITH_DISCOLOR_B)||(struGsh.nArithIndex == ARITH_CROSS));
    //switch(struCnfg.struLayerInfo[struGsh.nLayer].nViewSensorType[struGsh.nView])
    switch(struCnfp.nViewSensorType[0][struGsh.nView])
    {
    case SENSOR_T1:
...
void DiscolorSenseSetWidget::on_lineDefectCheckbox_clicked(bool checked)
{
...
void DiscolorSenseSetWidget::on_comboBox_delay_activated(int index)
{
