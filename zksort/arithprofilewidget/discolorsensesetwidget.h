#ifndef DISCOLORSENSESETWIDGET_H
#define DISCOLORSENSESETWIDGET_H
...
namespace Ui {
class DiscolorSenseSetWidget;
}

class DiscolorSenseSetWidget : public basewidget
{
    Q_OBJECT

public:
    explicit DiscolorSenseSetWidget(QWidget *parent = 0);
    ~DiscolorSenseSetWidget();
...
private:
    Ui::DiscolorSenseSetWidget *ui;
};

#endif // DISCOLORSENSESETWIDGET_H
