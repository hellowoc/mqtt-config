#ifndef COLORHUESENSESETWIDGET_H
#define COLORHUESENSESETWIDGET_H
...
namespace Ui {
class ColorHueSenseSetWidget;
}

class ColorHueSenseSetWidget : public basewidget
{
    Q_OBJECT

public:
    explicit ColorHueSenseSetWidget(QWidget *parent = 0);
    ~ColorHueSenseSetWidget();
    void showPage(bool bshow = true);
    void receiveMsg(int msg1, int msg2, int msg3);

private:
    Ui::ColorHueSenseSetWidget *ui;
    void updateValue();
...
#endif // COLORHUESENSESETWIDGET_H
